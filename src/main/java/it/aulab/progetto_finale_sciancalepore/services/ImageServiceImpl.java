...
import it.aulab.progetto_finale_sciancalepore.repositories.ImageRepository;
import it.aulab.progetto_finale_sciancalepore.utils.StringManipulation;
...
public class ImageServiceImpl implements ImageService {
    ...
    public CompletableFuture<String> saveImageOnCloud(MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            ...
            throw new IllegalArgumentException("File è vuoto");
        }
