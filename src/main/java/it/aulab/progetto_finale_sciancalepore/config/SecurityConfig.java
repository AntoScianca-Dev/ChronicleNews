...
import it.aulab.progetto_finale_sciancalepore.services.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                authorize.requestMatchers( "/register/**", "/register", "/css/**","/js/**", "/articles", "/", "/images/**", "/articles/detail/**", "/categories/search/{id}", "/search/{id}", "/articles/search").permitAll()
